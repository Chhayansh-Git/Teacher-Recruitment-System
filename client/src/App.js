...
import ManageEmailTemplatesPage from './pages/admin/ManageEmailTemplatesPage'; // <-- NEW IMPORT
import EmailTemplateFormPage from './pages/admin/EmailTemplateFormPage';       // <-- NEW IMPORT
      ...
      <AuthProvider>
        <Router>
          <Routes>
            ...
            <Route path="/admin/email-templates" element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><ManageEmailTemplatesPage /></DashboardLayout></ProtectedRoute>} /> {/* <-- NEW ROUTE */}
            <Route path="/admin/email-templates/new" element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><EmailTemplateFormPage /></DashboardLayout></ProtectedRoute>} />      {/* <-- NEW ROUTE */}
            <Route path="/admin/email-templates/edit/:key" element={<ProtectedRoute allowedRoles={['admin']}><DashboardLayout><EmailTemplateFormPage /></DashboardLayout></ProtectedRoute>} /> {/* <-- NEW ROUTE */}
